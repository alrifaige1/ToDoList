...
const deletePage=OverlayDelete.init(homeRoot)
...
if (!addTaskButton) {
  throw new Error("Couldn't find add task button")
}
if (!listTask) {
  throw new Error("Couldn't find list task root")
}

const addTask=AddTask.init(addTaskButton,listTask)